 ...
 **将纬度/经度对转换为x和y坐标，横向墨卡托投影。 请注意，横轴墨卡托与UTM不同；
 *需要比例因子在它们之间进行转换。 Reference: Hoffmann-Wellenhof, B.,
 *Lichtenegger, H., and Collins, J., GPS: Theory and Practice, 3rd ed.  New
 *York: Springer-Verlag Wien, 1994.
 *
 * Inputs:
 *    phi - Latitude of the point, in radians.
 ...
 *
 */
void UTMXYToLatLon(double x, double y, int zone, bool southhemi,
                   WGS84Corr& latlon) {
  double cmeridian;
