...
if(_hdmap_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED hdmap_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(hdmap_FOUND FALSE)
  elseif(NOT hdmap_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(hdmap_FOUND FALSE)
  endif()
  return()
endif()
set(_hdmap_CONFIG_INCLUDED TRUE)

# output package information
if(NOT hdmap_FIND_QUIETLY)
  message(STATUS "Found hdmap: 0.0.0 (${hdmap_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'hdmap' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${hdmap_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(hdmap_FOUND_AMENT_PACKAGE TRUE)
