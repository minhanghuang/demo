...
#ifndef HDMAP__SRV__DETAIL__LOCAL_MAP__FUNCTIONS_H_
#define HDMAP__SRV__DETAIL__LOCAL_MAP__FUNCTIONS_H_
...
#include "hdmap/msg/rosidl_generator_c__visibility_control.h"

#include "hdmap/srv/detail/local_map__struct.h"

/// Initialize srv/LocalMap message.
/**
...
/// Create srv/LocalMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hdmap__srv__LocalMap_Request__init().
...
/// Destroy srv/LocalMap message.
/**
 * It calls
 * hdmap__srv__LocalMap_Request__fini()
...
/// Initialize array of srv/LocalMap messages.
/**
...
/// Finalize array of srv/LocalMap messages.
/**
 * It calls
 * hdmap__srv__LocalMap_Request__fini()
...
/// Create array of srv/LocalMap messages.
/**
 * It allocates the memory for the array and calls
 * hdmap__srv__LocalMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LocalMap messages.
/**
 * It calls
 * hdmap__srv__LocalMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hdmap__srv__LocalMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hdmap
...
/**
 * It calls
 * hdmap__srv__LocalMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hdmap
...
/**
 * It allocates the memory for the array and calls
 * hdmap__srv__LocalMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hdmap
...
/**
 * It calls
 * hdmap__srv__LocalMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HDMAP__SRV__DETAIL__LOCAL_MAP__FUNCTIONS_H_
